...
Primero, integremos por partes $\eabc\f^2 \D\Sigma^{ab}e^c$. Notemos que
\begin{align}
...
%  \lambda\phi^2\eabc\D \S^{ab}e^c=-4\lambda\eabc\dd\phi e^{a}z^be^c+4\lambda\phi\eabc T^{a}z^be^c-4\lambda\eabc e^{a}\D z^be^c
%\end{equation}
%
