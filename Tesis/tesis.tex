...
% Este documento está actualizado a las guías del sistema de bibliotecas de la Universidad de Concepción, solo debes cambiarles los datos correspondientes a tu situación.
...
\usepackage{amsmath,amssymb,amsfonts,dsfont,mathrsfs,amsthm,mathtools}          % paquetes matemáticos
...
\bibliographystyle{unsrt}                                                 % Estilo de referencias APA.
...
\fancypagestyle{frontpage}{             % Se define el estilo frontpage.
	...
	\   % Línea 2 de la cabecera derecha, debe ir el nombre de la facultad en mayúsculas.
	\fancyhead{\centering \includegraphics[width=1.8in]{Images/logo-unap2.jpg}                       % Línea 1 de la cabecera derecha, debe ir el nombre de la UdeC en mayúsculas.
	\linebreak\linebreak       Instituto de Ciencias Exactas y Naturales \\ Facultad de Ciencias} % LOGO que irá en la cabecera izquierda.
}
...
\textcopyright\ 2024, Borja Diez Bravo \\ % Derechos de autor
%a)
