...
\def\title{Zero weight scalar fields} 
\usepackage{graphicx}
...
\begin{abstract}
\vspace{0.5cm}
Personal compilation of some calculations related to zero-weight conformal scalar fields.
\end{abstract}}
...
%\input{differentialble-manifolds.tex}
\input{cal.tex}
